...
tests/CMakeFiles/recv_reorder_sanitized.dir/recv_reorder.cc.o: /tmp/minnow/tests/recv_reorder.cc
tests/CMakeFiles/recv_reorder_sanitized.dir/recv_reorder.cc.o: tests/CMakeFiles/recv_reorder_sanitized.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=/tmp/minnow/cmake-build-debug-docker/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/recv_reorder_sanitized.dir/recv_reorder.cc.o"
	cd /tmp/minnow/cmake-build-debug-docker/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT tests/CMakeFiles/recv_reorder_sanitized.dir/recv_reorder.cc.o -MF CMakeFiles/recv_reorder_sanitized.dir/recv_reorder.cc.o.d -o CMakeFiles/recv_reorder_sanitized.dir/recv_reorder.cc.o -c /tmp/minnow/tests/recv_reorder.cc
...
tests/CMakeFiles/recv_reorder_sanitized.dir/recv_reorder.cc.i: cmake_force
	...
	cd /tmp/minnow/cmake-build-debug-docker/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/minnow/tests/recv_reorder.cc > CMakeFiles/recv_reorder_sanitized.dir/recv_reorder.cc.i
...
tests/CMakeFiles/recv_reorder_sanitized.dir/recv_reorder.cc.s: cmake_force
	...
	cd /tmp/minnow/cmake-build-debug-docker/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/minnow/tests/recv_reorder.cc -o CMakeFiles/recv_reorder_sanitized.dir/recv_reorder.cc.s
...
tests/recv_reorder_sanitized: tests/CMakeFiles/recv_reorder_sanitized.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=/tmp/minnow/cmake-build-debug-docker/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable recv_reorder_sanitized"
	cd /tmp/minnow/cmake-build-debug-docker/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/recv_reorder_sanitized.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/recv_reorder_sanitized.dir/clean:
	cd /tmp/minnow/cmake-build-debug-docker/tests && $(CMAKE_COMMAND) -P CMakeFiles/recv_reorder_sanitized.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/recv_reorder_sanitized.dir/clean

tests/CMakeFiles/recv_reorder_sanitized.dir/depend:
	cd /tmp/minnow/cmake-build-debug-docker && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/minnow /tmp/minnow/tests /tmp/minnow/cmake-build-debug-docker /tmp/minnow/cmake-build-debug-docker/tests /tmp/minnow/cmake-build-debug-docker/tests/CMakeFiles/recv_reorder_sanitized.dir/DependInfo.cmake "--color=$(COLOR)"
