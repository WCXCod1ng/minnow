...
tests/CMakeFiles/send_retx_sanitized.dir/send_retx.cc.o: /tmp/minnow/tests/send_retx.cc
tests/CMakeFiles/send_retx_sanitized.dir/send_retx.cc.o: tests/CMakeFiles/send_retx_sanitized.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=/tmp/minnow/cmake-build-debug-docker/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/send_retx_sanitized.dir/send_retx.cc.o"
	cd /tmp/minnow/cmake-build-debug-docker/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT tests/CMakeFiles/send_retx_sanitized.dir/send_retx.cc.o -MF CMakeFiles/send_retx_sanitized.dir/send_retx.cc.o.d -o CMakeFiles/send_retx_sanitized.dir/send_retx.cc.o -c /tmp/minnow/tests/send_retx.cc
...
tests/CMakeFiles/send_retx_sanitized.dir/send_retx.cc.i: cmake_force
	...
	cd /tmp/minnow/cmake-build-debug-docker/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/minnow/tests/send_retx.cc > CMakeFiles/send_retx_sanitized.dir/send_retx.cc.i
...
tests/CMakeFiles/send_retx_sanitized.dir/send_retx.cc.s: cmake_force
	...
	cd /tmp/minnow/cmake-build-debug-docker/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/minnow/tests/send_retx.cc -o CMakeFiles/send_retx_sanitized.dir/send_retx.cc.s
...
tests/send_retx_sanitized: tests/CMakeFiles/send_retx_sanitized.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=/tmp/minnow/cmake-build-debug-docker/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable send_retx_sanitized"
	cd /tmp/minnow/cmake-build-debug-docker/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/send_retx_sanitized.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/send_retx_sanitized.dir/clean:
	cd /tmp/minnow/cmake-build-debug-docker/tests && $(CMAKE_COMMAND) -P CMakeFiles/send_retx_sanitized.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/send_retx_sanitized.dir/clean

tests/CMakeFiles/send_retx_sanitized.dir/depend:
	cd /tmp/minnow/cmake-build-debug-docker && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/minnow /tmp/minnow/tests /tmp/minnow/cmake-build-debug-docker /tmp/minnow/cmake-build-debug-docker/tests /tmp/minnow/cmake-build-debug-docker/tests/CMakeFiles/send_retx_sanitized.dir/DependInfo.cmake "--color=$(COLOR)"
