...
tests/CMakeFiles/reassembler_seq_sanitized.dir/reassembler_seq.cc.o: /tmp/minnow/tests/reassembler_seq.cc
tests/CMakeFiles/reassembler_seq_sanitized.dir/reassembler_seq.cc.o: tests/CMakeFiles/reassembler_seq_sanitized.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=/tmp/minnow/cmake-build-debug-docker/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/reassembler_seq_sanitized.dir/reassembler_seq.cc.o"
	cd /tmp/minnow/cmake-build-debug-docker/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT tests/CMakeFiles/reassembler_seq_sanitized.dir/reassembler_seq.cc.o -MF CMakeFiles/reassembler_seq_sanitized.dir/reassembler_seq.cc.o.d -o CMakeFiles/reassembler_seq_sanitized.dir/reassembler_seq.cc.o -c /tmp/minnow/tests/reassembler_seq.cc
...
tests/CMakeFiles/reassembler_seq_sanitized.dir/reassembler_seq.cc.i: cmake_force
	...
	cd /tmp/minnow/cmake-build-debug-docker/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/minnow/tests/reassembler_seq.cc > CMakeFiles/reassembler_seq_sanitized.dir/reassembler_seq.cc.i
...
tests/CMakeFiles/reassembler_seq_sanitized.dir/reassembler_seq.cc.s: cmake_force
	...
	cd /tmp/minnow/cmake-build-debug-docker/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/minnow/tests/reassembler_seq.cc -o CMakeFiles/reassembler_seq_sanitized.dir/reassembler_seq.cc.s
...
tests/reassembler_seq_sanitized: tests/CMakeFiles/reassembler_seq_sanitized.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=/tmp/minnow/cmake-build-debug-docker/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable reassembler_seq_sanitized"
	cd /tmp/minnow/cmake-build-debug-docker/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/reassembler_seq_sanitized.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/reassembler_seq_sanitized.dir/clean:
	cd /tmp/minnow/cmake-build-debug-docker/tests && $(CMAKE_COMMAND) -P CMakeFiles/reassembler_seq_sanitized.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/reassembler_seq_sanitized.dir/clean

tests/CMakeFiles/reassembler_seq_sanitized.dir/depend:
	cd /tmp/minnow/cmake-build-debug-docker && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/minnow /tmp/minnow/tests /tmp/minnow/cmake-build-debug-docker /tmp/minnow/cmake-build-debug-docker/tests /tmp/minnow/cmake-build-debug-docker/tests/CMakeFiles/reassembler_seq_sanitized.dir/DependInfo.cmake "--color=$(COLOR)"
