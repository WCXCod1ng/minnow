...
tests/CMakeFiles/recv_close_sanitized.dir/recv_close.cc.o: /tmp/minnow/tests/recv_close.cc
tests/CMakeFiles/recv_close_sanitized.dir/recv_close.cc.o: tests/CMakeFiles/recv_close_sanitized.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=/tmp/minnow/cmake-build-debug-docker/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/recv_close_sanitized.dir/recv_close.cc.o"
	cd /tmp/minnow/cmake-build-debug-docker/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT tests/CMakeFiles/recv_close_sanitized.dir/recv_close.cc.o -MF CMakeFiles/recv_close_sanitized.dir/recv_close.cc.o.d -o CMakeFiles/recv_close_sanitized.dir/recv_close.cc.o -c /tmp/minnow/tests/recv_close.cc
...
tests/CMakeFiles/recv_close_sanitized.dir/recv_close.cc.i: cmake_force
	...
	cd /tmp/minnow/cmake-build-debug-docker/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/minnow/tests/recv_close.cc > CMakeFiles/recv_close_sanitized.dir/recv_close.cc.i
...
tests/CMakeFiles/recv_close_sanitized.dir/recv_close.cc.s: cmake_force
	...
	cd /tmp/minnow/cmake-build-debug-docker/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/minnow/tests/recv_close.cc -o CMakeFiles/recv_close_sanitized.dir/recv_close.cc.s
...
tests/recv_close_sanitized: tests/CMakeFiles/recv_close_sanitized.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=/tmp/minnow/cmake-build-debug-docker/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable recv_close_sanitized"
	cd /tmp/minnow/cmake-build-debug-docker/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/recv_close_sanitized.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/recv_close_sanitized.dir/clean:
	cd /tmp/minnow/cmake-build-debug-docker/tests && $(CMAKE_COMMAND) -P CMakeFiles/recv_close_sanitized.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/recv_close_sanitized.dir/clean

tests/CMakeFiles/recv_close_sanitized.dir/depend:
	cd /tmp/minnow/cmake-build-debug-docker && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/minnow /tmp/minnow/tests /tmp/minnow/cmake-build-debug-docker /tmp/minnow/cmake-build-debug-docker/tests /tmp/minnow/cmake-build-debug-docker/tests/CMakeFiles/recv_close_sanitized.dir/DependInfo.cmake "--color=$(COLOR)"
